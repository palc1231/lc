...
<head>
  ...
  <title>Welcome to mycakephp</title>
...
<section class='container'>
          <hgroup>
            <h1>Welcome to your CakePHP application on mytest</h1>
          </hgroup>
          ...
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>How to use this example application</h2>
                <p>For instructions on how to use this application with 我就试试, start by reading the <a href="http://docs.openshift.org/latest/dev_guide/templates.html#using-the-quickstart-templates">Developer Guide</a>.</p>
